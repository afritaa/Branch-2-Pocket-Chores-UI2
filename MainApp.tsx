...
const ThemeStyles = () => (
  <style>{`
    ...
    body[data-theme='pastel-dreams'] {
      --header-bg: #5D688A; --header-text: #FFF2EF;
      --page-bg: #FFF2EF;
      --card-bg: #ffffff;
      --menu-bg: #ffffff;
      --info-card-bg: #ffffff;
      --text-primary: #3d455c; --text-secondary: #5D688A; --text-muted: #9fa6b9;
      --accent-primary: #F7A5A5; --accent-primary-text: #5D688A;
      --accent-secondary: #FFDBB6;
      --border-primary: #e8dde9; --border-secondary: #d9c9d5;
    }
    
    body[data-theme='jungle'] {
      --header-bg: #1a4314; --header-text: #f2e8cf;
      --page-bg: #3e6259;
      --card-bg: rgba(26, 67, 20, 0.4);
      --menu-bg: #12300f;
      --info-card-bg: rgba(0,0,0,0.1);
      --text-primary: #f2e8cf; --text-secondary: #c9bda8; --text-muted: #a39a87;
      --accent-primary: #e3b448; --accent-primary-text: #1a4314;
      --accent-secondary: #cbd18f;
      --border-primary: rgba(242, 232, 207, 0.2); --border-secondary: rgba(242, 232, 207, 0.3);
    }
    
    body[data-theme='tropical'] {
      --header-bg: #0077b6; --header-text: #ffffff;
      --page-bg: #ade8f4;
      --card-bg: rgba(255, 255, 255, 0.7);
      --menu-bg: #ffffff;
      --info-card-bg: rgba(255, 255, 255, 0.6);
      --text-primary: #023e8a; --text-secondary: #0096c7; --text-muted: #48cae4;
      --accent-primary: #ef476f; --accent-primary-text: #ffffff;
      --accent-secondary: #ffd166;
      --border-primary: #90e0ef; --border-secondary: #caf0f8;
    }
    
    body[data-theme='sunset'] {
      --header-bg: #7209b7; --header-text: #ffffff;
      --page-bg: #b5179e;
      --card-bg: rgba(255, 255, 255, 0.15);
      --menu-bg: #560bad;
      --info-card-bg: rgba(255, 255, 255, 0.1);
      --text-primary: #ffffff; --text-secondary: #feeafa; --text-muted: #f9c5ed;
      --accent-primary: #fca311; --accent-primary-text: #ffffff;
      --accent-secondary: #f72585;
      --border-primary: rgba(255,255,255,0.2); --border-secondary: rgba(255,255,255,0.3);
    }
