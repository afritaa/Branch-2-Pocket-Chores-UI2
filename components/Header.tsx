                    ...
                    <div className="bg-[var(--header-bg)] text-[var(--header-text)] py-2 sm:py-4 rounded-b-lg">
                        <div className="flex items-center justify-between px-2 sm:px-4">
                            <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0">
                                ...
                                {profile && (
                                    <h2 className="text-xl sm:text-2xl leading-tight truncate">
                                        <span className="font-bold">{`${profile.name}'s`}</span>
                                        <span className="font-medium"> Pocket Money Chores.</span>
                                    </h2>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="bg-[var(--header-bg)] text-[var(--header-text)] py-2 sm:py-4 rounded-b-lg">
                        <div className="flex justify-between items-center px-2 sm:px-4">
                            <div className="flex items-center gap-2 sm:gap-4">
                                ...
                                <h1 className="font-medium text-xl sm:text-2xl text-left truncate">Pocket Money Chores.</h1>
                            </div>
