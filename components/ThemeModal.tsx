...
const themes = [
  ...
  { id: 'pastel-dreams', name: 'Pastel Dreams', colors: { bg: '#FFF2EF', header: '#5D688A', card: '#ffffff', accent: '#F7A5A5' } },
  { id: 'jungle', name: 'Jungle', colors: { bg: '#3e6259', header: '#1a4314', card: 'rgba(26, 67, 20, 0.4)', accent: '#e3b448' } },
  { id: 'tropical', name: 'Tropical', colors: { bg: '#ade8f4', header: '#0077b6', card: 'rgba(255, 255, 255, 0.7)', accent: '#ef476f' } },
  { id: 'sunset', name: 'Sunset', colors: { bg: '#b5179e', header: '#7209b7', card: 'rgba(255, 255, 255, 0.15)', accent: '#fca311' } },
];
                ...
                {themes.map(theme => (
                  <div key={theme.id} className="text-center">
                    <button
                      ...
                      className={`w-full h-24 rounded-lg border-4 transition-all duration-300 flex flex-col overflow-hidden
